package chapter8;
//HOMEWORK: Validate the complexity of a proposed  password by assuring it meets the rules:
...
// Конструктор для доступа к переменным username и currentPassword, с помощью которого можно присвоить значения переменных
